...
const TommorowSchFlatlist = ({ jobs, scrollToJobId }) => {
  ...
  const validJobs = jobs.filter(job => job.type !== 'Quote');
  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={ScheduleListStyle.titleContainer}>
        <Text style={ScheduleListStyle.titleMain}>Tommorow Schedule's</Text>
      </View>
...
export default TommorowSchFlatlist;
